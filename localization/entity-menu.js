...
cor_ru.entity_menu = {
    ...
    "mystery cyst": {
        name: `загадочная циста`,
        desc: `::ОТЗЫВЧИВАЯ МЫСЛЕФОРМА<br>::ЯВНОЕ НАЗНАЧЕНИЕ::'вспоминание'<br>::УНАСЛЕДОВАННЫЙ КОНТЕКСТ::<span style='color: var(--obesk-color)'>'загадка многих <span definition="УНАСЛЕДОВАННЫЙ КОНТЕКСТ::'отрезок времени';'обороты вокруг глаза велзи';'религиозный подтекст'">глаз</span>'</span>`
    },
