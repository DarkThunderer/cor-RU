...
cor_ru.entity_menu = {
    ...
    "these grand icons of their control": {
        ...
        desc: `::ВЫСКАЗЫВАЮЩАЯ МЫСЛЕФОРМА<br>::СОДЕРЖАНИЕ::'<br><span>величественные символы их власти</span><br><span>пусть они не наши</span><br><span>я чувствую гордость</span><br><span>за то что светлые близнецы покорили свою <span class="code">поверхность</span>!</span>'`
    },
    "they watch": {
        name: `они смотрят`,
